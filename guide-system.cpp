...
void ShowMenu()
{
	static const char *lines[] = {"***********************************************", "       武汉东湖学院校园导游信息系统主菜单       ", "***********************************************", "     1  景点地图整体管理                        ", "     2  校园景点数据管理                        ", "     3  景点交通数据管理                        ", "     4  校园景点信息查询                        ", "     5  游览线路查询规划                        ", "     6  景点最短路径查询                        ", "     7  管道系统最优布设                        ", "     0  退出校园导游系统                        ", "***********************************************"};
...
void ManaMapData(MatrixGraph &g)
{
	...
	do
	{
		static const char *menu[] = {"&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&", "        校园景点地图整体数据管理   ", "&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&", " 1 初始化景点地图数据               ", " 2 保存景点地图数据                 ", " 3 读取景点地图数据                 ", " 0 返回主菜单                       ", "&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&"};
...
void ManaVertexData(MatrixGraph &g)
{
	...
	do
	{
		static const char *menu[] = {"============================================", "               校园景点数据管理             ", "============================================", " 1 增加景点数据                               ", " 2 删除景点数据                               ", " 3 修改景点数据                               ", " 4 显示景点数据                               ", " 0 返回主菜单                                 ", "============================================"};
		for (const char *line : menu) { cout << line << endl; }
		cout << "请选择: ";
		cin >> choice;
		switch (choice)
...
void ManaRoadData(MatrixGraph &g)
{
	...
	do
	{
		static const char *menu[] = {"~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~", "             校园景点交通数据管理               ", "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~", " 1 增加景点交通数据                             ", " 2 删除景点交通数据                             ", " 3 修改景点交通数据                             ", " 4 显示景点交通数据                             ", " 0 返回主菜单                                   ", "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"};
		for (const char *line : menu) { cout << line << endl; }
		cout << "请选择: ";
		cin >> choice;
		switch (choice)
...
void VisitPathPlan(MatrixGraph &g)
{
	...
	do
	{
		static const char *menu[] = {"@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@", "        校园景点游览线路查询规划     ", "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@", " 1 深度优先游览线路查询规划         ", " 2 广度优先游览线路查询规划         ", " 0 返回主菜单                       ", "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@"};
		for (const char *line : menu) { cout << line << endl; }
		cout << "请选择: ";
		cin >> choice;
		switch (choice)
...
void ShortestPathQuery(MatrixGraph g)
{
	...
	do
	{
		static const char *menu[] = {"^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^", "             校园景点最短路径查询               ", "^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^", " 1 迪杰斯特拉(Dijkstra)算法                    ", " 2 弗洛伊德(Floyd)算法                         ", " 0 返回主菜单                                  ", "^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^"};
		for (const char *line : menu) { cout << line << endl; }
		cout << "请选择: ";
		cin >> choice;
		switch (choice)
...
void PipelineSystemOptimal(MatrixGraph g)
{
	...
	do
	{
		static const char *menu[] = {"#############################################", "             校园管道系统最优布设               ", "#############################################", " 1  普里姆(Prim)算法                           ", " 2  克鲁斯卡尔(Kruskal)算法                    ", " 0  返回主菜单                                 ", "#############################################"};
		for (const char *line : menu) { cout << line << endl; }
		cout << "请选择: ";
		cin >> choice;
		switch (choice)
